...
def split_data(file_path, label_path, new_file_path, train_rate, val_rate, test_rate):
	print("Looking for file path:", file_path)
...
if __name__ == '__main__':
	file_path = r'G:\ultralytics-8.3.116\ultralytics-8.3.116\data\JPRGImages'  # 图片文件夹
	label_path = r'G:\ultralytics-8.3.116\ultralytics-8.3.116\data\labels'  # 标签文件夹
	new_file_path = r'G:\ultralytics-8.3.116\ultralytics-8.3.116\VOCdevkit'  # 新数据存放位置
